    ...
    articles.forEach((article) => {
        ...
        articleCard.innerHTML = `
            <div class="article-header">
                <h3><i class="fas fa-file-alt"></i> ${article.title || 'Untitled'}</h3>
            ...
            <p class="year"><i class="far fa-calendar-alt"></i> Year: ${article.year || 'Unknown Year'}</p>
            <p class="authors"><i class="fas fa-users"></i> Authors: ${Array.isArray(article.authors) ? article.authors.join(', ') : 'Unknown Author'}</p>
            ${article.link ? `<a href="${article.link}" target="_blank" class="read-more"><i class="fas fa-external-link-alt"></i> Read More</a>` : ''}
        `;
